...
public class OrdersMapper {
    ...
    public static OrdersEntity toEntity(OrdersDTO dto) {
        ...
        // Do not set orderId for new orders as it is generated by the database.

        // Map MenuItemOrdersDTO to MenuItemOrdersEntity
        // Assuming you have a collection of MenuItemOrdersDTO in your OrdersDTO.
        List<MenuItemOrdersEntity> menuItemOrders = dto.getMenuItemOrders().stream()
                .map(MenuItemOrdersMapper::toEntity)
